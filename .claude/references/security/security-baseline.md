...
If the application exposes an API, also read `references/security/api-security.md` and complete the API checklist.

If the application involves AI, LLMs, agents, or MCP tools, also read `references/security/ai-security.md` and complete the AI checklist.
...
- [ ] All items in `references/security/api-security.md` checked (if applicable)
- [ ] All items in `references/security/ai-security.md` checked (if applicable)
